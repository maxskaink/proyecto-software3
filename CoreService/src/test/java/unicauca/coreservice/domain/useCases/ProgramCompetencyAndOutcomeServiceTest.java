...
class ProgramCompetencyAndOutcomeServiceTest {
    ...
    void add_shouldThrowExceptionWhenDuplicateDescription() throws Exception {
        ...
        assertThrows(DuplicateInformation.class, () -> service.add(competency));
    }
    ...
    void add_shouldThrowExceptionWhenMissingRequiredData() {
        ...
        Exception exception1 = assertThrows(InvalidValue.class, () -> new ProgramCompetency(null, null, "Basic", outcome, new ArrayList<>()));
        assertEquals("The description can not be null or empty", exception1.getMessage());
        
        // Act & Assert - Missing level
        Exception exception2 = assertThrows(InvalidValue.class, () -> new ProgramCompetency(null, "Test Competency", null, outcome, new ArrayList<>()));
    ...
    void getProgramCompetencyById_shouldThrowExceptionWhenNotExists() {
        ...
        // Act & Assert
        assertThrows(NotFound.class, () -> service.getProgramCompetencyById(id));
    ...
    void getProgramCompetencyById_shouldThrowExceptionWhenIdIsNull() {
        // Act & Assert
        Exception exception = assertThrows(InvalidValue.class, () -> service.getProgramCompetencyById(null));
    ...
    void updateProgramCompetency_shouldThrowExceptionWhenIdIsNull() {
        ...
        // Act & Assert
        Exception exception = assertThrows(InvalidValue.class, () -> service.updateProgramCompetency(null, competency));
    ...
    void updateProgramCompetency_shouldThrowExceptionWhenCompetencyIsNull() {
        ...
        Exception exception = assertThrows(InvalidValue.class, () -> service.updateProgramCompetency(1, null));
    ...
    void remove_shouldReturnRemovedCompetency() throws Exception {
        ...
        assertThrows(NotFound.class, () -> service.getProgramCompetencyById(compAdded.getId()));
    ...
    void remove_shouldThrowExceptionWhenIdIsNull() {
        // Act & Assert
        Exception exception = assertThrows(InvalidValue.class, () -> service.remove(null));
    ...
    void listAllProgramOutcomes_shouldReturnAllOutcomes() throws Exception {
        ...
        List<ProgramCompetency> expectedCompetency = Arrays.asList(
        ...
        // Act
        for(ProgramCompetency cmp: expectedCompetency)
            service.add(cmp);

        List<ProgramOutcome> result = service.listAllProgramOutcomes();

        // Assert
        assertEquals(expectedCompetency.size(), result.size());
    }
    ...
    @Test
    void getProgramOutcomeById_shouldThrowExceptionWhenNotExists(){
        // Arrange
        Integer id = 999;
        // Act & Assert
        assertThrows(Exception.class, () -> service.getProgramOutcomeById(id));
    }

    @Test
    void getProgramOutcomeById_shouldThrowExceptionWhenIdIsNull() {
        // Act & Assert
        Exception exception = assertThrows(InvalidValue.class, () -> service.getProgramOutcomeById(null));
